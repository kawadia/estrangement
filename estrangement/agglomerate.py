...
def modularity(partition, graph) :
    ...
    """Function to compute the modularity of a partitioning of a graph.
    ...
    References
    ----------
    .. [Newman04] Newman, M.E.J. & Girvan, M. Finding and evaluating community structure in networks. Physical Review E 69, 26113(2004).
...
def best_partition(graph, delta, tolerance, tiebreaking, lambduh, Zgraph, partition = None,q=multiprocessing.Queue()) :
    ...
    (or try to) using the Louvain heuristices.
...
def generate_dendogram(graph, delta, tolerance, tiebreaking, lambduh, Zgraph, part_init = None) :
    ...
    the size of the communities. See: [Blondel08]_
