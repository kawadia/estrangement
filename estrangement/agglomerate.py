...
def partition_at_level(dendogram, level) :
    ...
    partition : dictionnary
       A dictionary where keys are the nodes and the values are the set to which it belongs.
    ...
    See Also
    --------
    'Best_partition' which directly combines 'partition_at_level' and 'generate_dendogram' to 
    obtain the partition of highest modularity.
...
def modularity(partition, graph) :
    ...
    """Function to compute the modularity of a partition of a graph.
...
def induced_graph(partition, graph, zgraph) :
    ...
    """Function to produce the graph where nodes are the communities.

    There is a link of weight w between communities if the sum of the weights of the 
    links between their elements is w.
    ...
    -------
    g : networkx.Graph
       A networkx graph where nodes are the partitions.
